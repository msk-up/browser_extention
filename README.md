...
- If tab capture is unavailable in your browser build, the extension falls back to microphone capture via an offscreen document (Chrome will prompt for mic access when first requested).
